---
title: "依赖锁文件"
description: "说明 bun.lock 与 uv.lock 的可复现构建作用，并保留完整生成内容供排查。"
---

<Callout title="生成文件，不建议逐行阅读">

`bun.lock` 与 `uv.lock` 的职责是把“依赖范围”固定为“可复现的精确版本与校验信息”。它们应由包管理器生成，不应手工维护。
...
<Tabs items={['前端', '后端']}>
  <Tab>
    `bun.lock` 固定 JavaScript/TypeScript 依赖、传递依赖和完整性校验，使本地、CI 与生产构建使用同一依赖图。
  </Tab>
  <Tab>
    `uv.lock` 固定 Python 包版本、平台条件和依赖关系，使 `uv sync --frozen` 能得到确定性环境。
  </Tab>
</Tabs>

## 学习时关注什么

- 观察顶层工作区依赖，理解项目采用了哪些核心库。
- 遇到依赖冲突时，再搜索具体包名及其版本约束。
- 不要把锁文件当作架构设计文档；真正的依赖意图应从各级 `package.json` 与 `pyproject.toml` 阅读。
...
```text title="bun.lock"
{
  ...
  "packages": {
    ...
    "@tanstack/router-devtools": ["@tanstack/router-devtools@1.167.0", "", { "dependencies": { "@tanstack/react-router-devtools": "1.167.0", "clsx": "^2.1.1", "goober": "^2.1.16" }, "peerDependencies": { "@tanstack/react-router": "^1.170.0", "csstype": "^3.0.10", "react": ">=18.0.0 || >=19.0.0", "react-dom": ">=18.0.0 || >=19.0.0" }, "optionalPeers": ["csstype"] }, "sha512-NwHy3SNoEgGraWtOstykkBPCTv7QRWBuPH49ww3prsyzQWXSSb7/2Jp7HHndpDrAIn0XNCCaxho90+6RFLSpUA=="],
...
requires-dist = [
    ...
    { name = "emails", specifier = ">=1.1.2,<2.0" },
    { name = "fastapi", extras = ["standard"], specifier = ">=0.141.1,<1.0.0" },
    ...
    { name = "sentry-sdk", extras = ["fastapi"], specifier = ">=2.66.1,<3.0.0" },
    { name = "sqlmodel", specifier = ">=0.0.39,<1.0.0" },
...
dev = [
    ...
    { name = "mypy", specifier = ">=1.8.0,<3.0.0" },
...
sdist = { url = "https://files.pythonhosted.org/packages/25/bb/073e0244a4da617a1e7add93779e3a40ec173a36ff81b396450d73313f33/emails-1.1.2.tar.gz", hash = "sha256:9fd216b691704b3df9ad70073fc85945ba4e8eac80198233919cfa2488af8665", size = 37156, upload-time = "2026-05-18T13:26:29.958Z" }
wheels = [
    { url = "https://files.pythonhosted.org/packages/bb/7a/d64aea2f1bd6838fed3131460394c0d9d67c016a3fa1b45ef861a83310bc/emails-1.1.2-py3-none-any.whl", hash = "sha256:0ab991876921eeac13039d5be93192ab27da1600afa7d7ea6d51dfa7cd006eda", size = 42920, upload-time = "2026-05-18T13:26:28.702Z" },
]
...
sdist = { url = "https://files.pythonhosted.org/packages/60/c3/5cd0b824ca4b4fd073ce998321881ed68b8e0b85d441653eb1bd997c6fc0/fastapi_cloud_cli-0.21.0.tar.gz", hash = "sha256:463350dcbdcbb9b3baa32a99a3db0610f34a3ae143dd1d35a71173aec5dd245d", size = 93804, upload-time = "2026-06-24T15:23:07.554Z" }
wheels = [
    { url = "https://files.pythonhosted.org/packages/15/a0/2ec3fb041fd41281073cb11ed6c63a33bc1f7a315554e26256a9709dbe47/fastapi_cloud_cli-0.21.0-py3-none-any.whl", hash = "sha256:ea49208fb301b2298e6ddaf9225163cf6dbb255bc9126001242f3cd21486bbe6", size = 76195, upload-time = "2026-06-24T15:23:06.609Z" },
]
