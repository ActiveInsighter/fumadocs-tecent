...
<include cwd>content/snippets/apps/docs/content/docs/mdx/(integrations)/next.mdx#setup-section</include>
...
<include cwd meta='title="lib/layout.shared.tsx"'>
  content/snippets/examples/next-min/lib/layout.shared.tsx
</include>

Create the following files & routes:

<include cwd meta='tab="components/mdx.tsx"'>
  content/snippets/examples/next-min/components/mdx.tsx
</include>

<include cwd meta='tab="app/docs/layout.tsx"'>
  content/snippets/examples/next-min/app/docs/layout.tsx
</include>

<include cwd meta='tab="app/docs/[[...slug]]/page.tsx"'>
  content/snippets/examples/next-min/app/docs/[[...slug]]/page.tsx
</include>

<include cwd meta='tab="app/api/search/route.ts"'>
  content/snippets/examples/next-min/app/api/search/route.ts
</include>
