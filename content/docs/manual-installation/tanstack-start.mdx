...
<include cwd meta='tab="components/mdx.tsx"'>
  content/snippets/examples/tanstack-start-min/src/components/mdx.tsx
</include>
<include cwd meta='tab="lib/layout.shared.tsx"'>
  content/snippets/examples/tanstack-start-min/src/lib/layout.shared.tsx
</include>
<include cwd meta='tab="routes/docs/$.tsx"'>
  content/snippets/examples/tanstack-start-min/src/routes/docs/$.tsx
</include>
<include cwd meta='tab="routes/api/search.ts"'>
  content/snippets/examples/tanstack-start-min/src/routes/api/search.ts
</include>
