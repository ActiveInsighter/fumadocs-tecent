...
>
> See [Custom Content Source](https://fumadocs.dev/docs/integrations/content/custom) for details.
...
You can use the [`schema`](https://fumadocs.dev/docs/mdx/collections#schema-1) option to add frontmatter properties.
...
<Cards>
  ...
  <Card href="/" title="Home">
    Cards can also include icons when an icon component is available.
  </Card>
</Cards>
```
...
[Browse the official navigation documentation](https://fumadocs.dev/docs/ui/navigation).
...
Syntax Highlighting is supported by default using [Rehype Code](https://fumadocs.dev/docs/headless/mdx/rehype-code).
...
See [other usages of include](https://fumadocs.dev/docs/mdx/include).
...
See [`remark-npm`](https://fumadocs.dev/docs/headless/mdx/remark-npm) for details.

### Steps

Useful for denoting steps for guides, see [`remark-steps`](https://fumadocs.dev/docs/headless/mdx/remark-steps) for enable & configure.
...
You can configure & use the [built-in components](https://fumadocs.dev/docs/ui/components) in your MDX document, such as Tabs, Accordions and Zoomable Image.
...
<Cards>
  <Card href="/docs/markdown/math" title="Math">
    Write TeX equations with remark-math and KaTeX.
  </Card>
  <Card href="/docs/markdown/mermaid" title="Mermaid">
    Render diagrams directly from MDX.
  </Card>
