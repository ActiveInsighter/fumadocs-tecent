...
<include cwd>content/snippets/apps/docs/content/docs/headless/search/.static-route-example.mdx</include>

Finally, the exported records can be accessed at:

<include cwd>content/snippets/apps/docs/content/docs/headless/search/.static-route-output.mdx#static-route-output</include>
