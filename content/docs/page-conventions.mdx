...
Fumadocs generates **page slugs** and **page tree** (sidebar items) from your content directory using [`loader()`](https://fumadocs.dev/docs/headless/source-api),
...
To customize its output further, you may use [Loader Plugins](https://fumadocs.dev/docs/headless/source-api/plugins).
...
On Fumadocs MDX, you can specify a [`schema`](https://fumadocs.dev/docs/mdx/collections#schema-1) option to customize frontmatter schema.
...
Fumadocs UI renders root folders as [Layout Tabs](https://fumadocs.dev/docs/ui/layouts/docs#layout-tabs), which allows users to switch between them.
...
You can add an [`icon` handler](https://fumadocs.dev/docs/headless/source-api#icons) to `loader()`.
